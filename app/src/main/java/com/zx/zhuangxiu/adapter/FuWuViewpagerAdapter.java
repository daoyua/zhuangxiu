...
public class FuWuViewpagerAdapter extends FragmentPagerAdapter {

    private List<DaxiaofenleiBean.DataBean> mList;
    private int type;

    public FuWuViewpagerAdapter(FragmentManager fm, List<DaxiaofenleiBean.DataBean> list, int type) {
        super(fm);
        this.mList = list;
        this.type = type;
    }
