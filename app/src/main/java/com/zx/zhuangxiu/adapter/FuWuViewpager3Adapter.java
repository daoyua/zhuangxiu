...
public class FuWuViewpager3Adapter extends FragmentPagerAdapter {

    private List<DaxiaofenleiBean.DataBean> mList;
    private int type;

    public FuWuViewpager3Adapter(FragmentManager fm, List<DaxiaofenleiBean.DataBean> list, int type) {
        super(fm);
