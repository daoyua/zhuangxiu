...
public class DetailsTwo {
    ...
    public void setJskIndexStandard(List<DetailsFour> jskIndexStandard) {
        this.jskIndexStandard = jskIndexStandard;
    }
    ...
    public void setJskSysAnnex(List<DetailsThree> jskSysAnnex) {
