...
public class FoundFu3WuActivity extends AppCompatActivity implements View.OnClickListener {
        ...
        OkHttpUtils.get(url, new OkHttpUtils.ResultCallback<DaxiaofenleiBean>() {
            ...
            public void onSuccess(DaxiaofenleiBean response) {
                ...
                if (response.getResult() == 1){
                    ...
                    fuWuViewpagerAdapter = new FuWuViewpager3Adapter(getSupportFragmentManager(), mlist, type);
    ...
    private void initView() {
        ...
        serves_search = findViewById(R.id.serves_search);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.serves_search:
                intent.setClass(FoundFu3WuActivity.this, FaBuFuWuActivity.class);
                startActivity(intent);
                break;
            case R.id.img_search:
                intent.setClass(FoundFu3WuActivity.this, ZfwSearchActivity.class);
                startActivity(intent);
                break;
            default:
                break;
