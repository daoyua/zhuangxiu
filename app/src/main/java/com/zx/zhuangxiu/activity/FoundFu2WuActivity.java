...
import com.zx.zhuangxiu.adapter.FuWuViewpager2Adapter;
import com.zx.zhuangxiu.model.DaxiaofenleiBean;

import java.util.ArrayList;
import java.util.List;

public class FoundFu2WuActivity extends AppCompatActivity implements View.OnClickListener {

    private TabLayout mGoodsTab;
    private ViewPager goodsViewPager;
    private List<String> mList = new ArrayList<String>();
    private FuWuViewpager2Adapter fuWuViewpagerAdapter;
        ...
        OkHttpUtils.get(url, new OkHttpUtils.ResultCallback<DaxiaofenleiBean>() {
            ...
            public void onSuccess(DaxiaofenleiBean response) {
                ...
                if (response.getResult() == 1){
                    ...
                    fuWuViewpagerAdapter = new FuWuViewpager2Adapter(getSupportFragmentManager(), mlist, type);
    ...
    private void initView() {
        ...
        mList.add("家政保洁");
        mList.add("其他");
        mGoodsTab.setTabMode(TabLayout.MODE_FIXED);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.serves_search:
                intent.setClass(FoundFu2WuActivity.this, FaBuFuWuActivity.class);
                intent.putExtra("type",0);
                startActivity(intent);
                break;
            case R.id.img_search:
                intent.setClass(FoundFu2WuActivity.this, ZfwSearchActivity.class);
                startActivity(intent);
                break;
            default:
                break;
